...
class SamplerVectorPostprocessorTransfer;
class SamplerReceiver;
class SamplerFullSolveMultiApp;
class StochasticResults;

template <>
InputParameters validParams<SamplerVectorPostprocessorTransfer>();
 ...
 */
class SamplerVectorPostprocessorTransfer : public StochasticToolsTransfer
{
public:
  static InputParameters validParams();

  SamplerVectorPostprocessorTransfer(const InputParameters & parameters);
...
protected:
  ...
  /// Storage for StochasticResults object that data will be transferred to
