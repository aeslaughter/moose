...
template <>
void
mooseSetToZero<RankThreeTensorTempl<Real>>(RankThreeTensorTempl<DualReal> & v)
{
  v.zero();
}
...
template <typename T>
MooseEnum
RankThreeTensorTempl<T>::fillMethodEnum() // TODO: Need new fillMethodEnum() -- for now we will
