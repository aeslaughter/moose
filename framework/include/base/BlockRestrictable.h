...
public:
   ...
   * @param initialize Disable initialization, MooseVariableBase was converted to a MooseObject, this
   *                   flag allows it to be constructed as if it wasn't to maintain backward
   *                   compatibility, this will be removed in the fugure.
