...
protected:
   ...
   */
  void addParameter(const std::string & name, libMesh::Parameters::Value * value, hit::Node * parent, const InputParameters & parameters);
...
template<class T>
void
InputOutput::addActionSyntax(const std::string & name, hit::Node * parent, bool create_sections)
{
  // Locate the actions
