...
mug = chigger.exodus.ExodusResult(reader, camera=camera, block=('1',), cmap='shock',
                                  variable='diffused')

contour = chigger.filters.ContourFilter()
contour = chigger.exodus.ExodusResult(reader, camera=camera, block=('76',), variable='convected',
