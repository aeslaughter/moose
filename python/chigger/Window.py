...
class Window(base.ChiggerAlgorithm):
    ...
    def validOptions():
        ...
        # Background settings
        # TODO: Move these to 'background' sub-option
        """
...
#        return self.__viewports[0]
    ...
    def _onRequestInformation(self, *args):
        ...
        if self.getOption('offscreen'):
            ...
            # Add the default MainWindowObserver
