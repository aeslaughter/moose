...
class TestMooseApplicationSyntax(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        options = config['MooseDocs.extensions.MooseMarkdownExtension']
    ...
    def testMooseObjectInfo(self):
        ...
        md = os.path.join(MooseDocs.MOOSE_DIR, 'docs', 'content', 'documentation', 'systems', 'Adaptivity', 'Markers', 'framework', 'BoxMarker.md')
    ...
    def testMooseActionInfo(self):
        ...
        md = os.path.join(MooseDocs.MOOSE_DIR, 'docs', 'content', 'documentation', 'systems', 'Mesh', 'index.md')
