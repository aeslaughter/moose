...
class TestLatexMooseElements(testing.TestLatexBase):
    """
    Test the MOOSE specific html to latex conversion working.
    """
    ...
    def test_moose_img_caption(self):
        html = u'<p align="justify" class="moose-image-caption">Caption with <a href="http://foo.org">reference</a> inline.</p>'
    ...
    def test_moose_img(self):
        ...
        gold = '\\begin{figure}\n'
        gold += '\\label{thelabel}\n'
        gold += '\\includegraphics[width=\linewidth]{%s}\n' % img
        gold += '\\caption{The image caption with \href{http://foo.org}{reference} inline.}\n'
        gold += '\\end{figure}'
    ...
    def test_moose_pre_code(self):
        html = u'<pre class=" language-text"><button class="moose-copy-button btn"' \
                ...
                'language-text" id="moose-code-block-1">  params.addParam<int>("foo", 1, "doc");</code></pre>'
    ...
    def test_moose_code_div(self):
        html = u'<div class="moosedocs-code-div" style="max-height:200px;overflow-y:scroll;">' \
                ...
                'data-clipboard-target="#moose-code-block-0">copy</button><code class="text language-text" ' \
