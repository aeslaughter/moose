...
import MooseDocs
from MooseDocs.common import MooseAppSyntax
from MooseDocs.common.MooseAppSyntax import SyntaxNode, MooseObjectNode, ActionNode, \
...
class TestMooseAppSyntax(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        hide = {'framework': ['/Functions'], 'phase_field': ['/Modules/PhaseField'],
                'solid_mechanics': [''], 'all': ['/Modules/PhaseField']}

        cls._syntax = MooseAppSyntax(exe, hide=hide)
    ...
    def testObjects(self):
        ...
        """
        nodes = self._syntax.objects('/Kernels')
    ...
    def testActions(self):
        ...
        """
        nodes = self._syntax.actions('/Kernels')
        self.assertTrue(len(nodes))
        for node in nodes:
    ...
    def testGroups(self):
        ...
        """
        groups = self._syntax.groups()
        for g in ['framework', 'phase_field', 'level_set', 'tensor_mechanics']:
