#!/usr/bin/env python
"""Testing for MooseDocs.extensions.autolink MooseDocs extension."""
import os
import unittest
import tempfile
import shutil
...
import MooseDocs
from MooseDocs.extensions import core, autolink
...
class TestRenderAutoLinkHTML(TestAutoLinkBase):
    ...
    def testTree(self):
        ...
        self.assertEqual(a0['href'], u'file1.html')
        ...
        self.assertEqual(a1['href'], u'file1.html#sub')
    ...
    def testWrite(self):
        ...
        self.assertIn(u'href="file1.html', gold)
        self.assertIn(u'>Foo</a>', gold)

        gold = node(2)(0).write()
        self.assertIn(u'<a', gold)
        self.assertIn(u'href="file1.html#sub"', gold)
...
class TestRenderAutoLinkMaterialize(TestRenderAutoLinkHTML):
    ...
    def node(self):
        return self.root(0).render().find('moose-content', attr='class')(0)
